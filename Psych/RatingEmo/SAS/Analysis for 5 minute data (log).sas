...
/*	This is taking log at the end
   	...
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationAround1,
   		mean(log(Duration/30.0)) as MeanDurationAround1,
...
proc sql;
	create table Monitor_1 as
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationMonitor1,
   		mean(log(Duration/30.0)) as MeanDurationMonitor1,
...
proc sql;
	create table Keyboard_1 as
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationKeyboard1,
   		mean(log(Duration/30.0)) as MeanDurationKeyboard1,
...
proc sql;
	create table Face_1 as
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationFace1,
   		mean(log(Duration/30.0)) as MeanDurationFace1,
...
proc sql;
	create table Around_2 as
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationAround2,
   		mean(log(Duration/30.0)) as MeanDurationAround2,
...
proc sql;
	create table Monitor_2 as
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationMonitor2,
   		mean(log(Duration/30.0)) as MeanDurationMonitor2,
...
proc sql;
	create table Keyboard_2 as 
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationKeyboard2,
   		mean(log(Duration/30.0))  as MeanDurationKeyboard2,
...
proc sql;
	create table Face_2 as
   	select Dyad, sum(log(Duration/30.0)) as TotalDurationFace2,
   		mean(log(Duration/30.0)) as MeanDurationFace2,
